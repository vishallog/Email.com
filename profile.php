...
if($res->num_rows > 0){
    ...
    <table id='example' class='table table-striped table-bordered' cellspacing='0' width='100%'>
      <thead><tr><th>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspSr. No.</th><th width='20%'>From</th><th  width='30%'>Title</th><th  width='30%'>Message</th><th>Time</th></tr></thead>";
      $t=1;
      while($row = $res->fetch_assoc()) { 
       echo "<tr><th>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp$t</th><th>$row[Sender]</th><th>$row[Title]</th><th>$row[Body]</th><th>$row[Time]</th></tr>";
$t++;
              }   } 
?>
</tbody>
